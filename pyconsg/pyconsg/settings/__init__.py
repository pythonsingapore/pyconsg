# flake8: noqa
from pyconsg.settings.base_settings import *
from pyconsg.settings.django_settings import *
from pyconsg.settings.installed_apps import *
from pyconsg.settings.middleware_settings import *
