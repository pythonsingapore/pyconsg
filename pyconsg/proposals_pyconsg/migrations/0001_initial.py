...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('proposals_pyconsg_talkproposal', (
        ...
        db.send_create_signal('proposals_pyconsg', ['TalkProposal'])

        # Adding model 'TutorialProposal'
        db.create_table('proposals_pyconsg_tutorialproposal', (
            ('proposalbase_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['proposals.ProposalBase'], unique=True, primary_key=True)),
            ('audience_level', self.gf('django.db.models.fields.IntegerField')()),
            ('recording_release', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('proposals_pyconsg', ['TutorialProposal'])

        # Adding model 'StartupBoothProposal'
        db.create_table('proposals_pyconsg_startupboothproposal', (
            ('proposalbase_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['proposals.ProposalBase'], unique=True, primary_key=True)),
            ('audience_level', self.gf('django.db.models.fields.IntegerField')()),
            ('recording_release', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('proposals_pyconsg', ['StartupBoothProposal'])


    def backwards(self, orm):
        # Deleting model 'TalkProposal'
        db.delete_table('proposals_pyconsg_talkproposal')

        # Deleting model 'TutorialProposal'
        db.delete_table('proposals_pyconsg_tutorialproposal')

        # Deleting model 'StartupBoothProposal'
        db.delete_table('proposals_pyconsg_startupboothproposal')
    ...
    models = {
        ...
        'conference.conference': {
            ...
            'timezone': ('timezones.fields.TimeZoneField', [], {'default': "'America/Chicago'", 'max_length': '100', 'blank': 'True'}),
        ...
        'proposals_pyconsg.tutorialproposal': {
